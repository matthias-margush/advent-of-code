...
(ns part-1
  ...
  - bababc contains two a and three b, so it counts for both. abbcde contains
    two b, but
  - no letter appears exactly three times.
  - abcccd contains three c, but no letter
  ...
  exactly twice, and three of them contain a letter which appears exactly three
